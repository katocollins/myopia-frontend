...
const generateReport = async () => {
  ...
  try {
    ...
    const originalImageUrl = `${import.meta.env.VITE_IMAGE_BASE_URL}/${selectedDiagnosis.retinalImageId.originalImagePath.split("/").pop()}?t=${Date.now()}`;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 p-2 rounded-lg border border-gray-200">
                  <img
                    src={`${import.meta.env.VITE_IMAGE_BASE_URL}/${selectedDiagnosis.retinalImageId.originalImagePath.split("/").pop()}?t=${Date.now()}`}
